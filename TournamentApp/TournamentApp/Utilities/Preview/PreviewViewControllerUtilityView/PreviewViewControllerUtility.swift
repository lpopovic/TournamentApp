//
//  PreviewViewControllerUtilityView.swift
//  TournamentApp
//
//  Created by Lazar Popovic on 23.6.23..
//

import Foundation
import SwiftUI

struct PreviewViewControllerUtilityView: View {
    ...
    init(for viewController: UIViewController, navigationControllerStyle: NavigationControllerStyle = .none) {
