...
class ImagePickerView: NSObject  {
    ...
    init(presentationController: UIViewController, delegate: ImagePickerViewDelegate) {
    ...
    func present(from sourceView: UIView, with title: String) {
        
        let alertController = UIAlertController(title: title, message: "From where do you want to take the photo?", preferredStyle: .actionSheet)
